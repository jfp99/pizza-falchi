...
export const flyerMenuData: FlyerMenuData = {
  ...
  classiques: [
    { name: 'Anchois', price: 11.00, priceGrande: 13.50, description: 'Anchois' },
    { name: 'Fromage', price: 11.00, priceGrande: 13.50, isVegetarian: true, description: 'Emmental' },
    { name: 'Poivron', price: 11.50, priceGrande: 14.00, isVegetarian: true, description: 'Emmental, Poivron' },
    { name: 'Palermo', price: 12.00, priceGrande: 14.50, description: 'Emmental, Câpres, Anchois' },
    { name: 'Jambon', price: 12.00, priceGrande: 14.50, description: 'Emmental, Jambon' },
    { name: 'Venise', price: 12.00, priceGrande: 14.50, isVegetarian: true, description: 'Emmental, Mozzarella' },
    { name: 'Champignon', price: 12.00, priceGrande: 14.50, isVegetarian: true, description: 'Champignons de Paris, Emmental' },
    { name: 'Biquette', price: 12.50, priceGrande: 15.00, isVegetarian: true, description: 'Emmental, Chèvre' },
    { name: 'Belzebuth', price: 12.50, priceGrande: 15.00, isSpicy: true, description: 'Emmental, Chorizo' },
    { name: 'Roquefort', price: 13.00, priceGrande: 15.50, isVegetarian: true, description: 'Emmental, Roquefort' },
    { name: 'Figatelli', price: 13.00, priceGrande: 15.50, description: 'Emmental, Figatelli' },
    { name: 'Fruits de Mer', price: 13.00, priceGrande: 15.50, description: 'Emmental, Fruits de mer, Ail, Persil' },
    { name: 'Kebab', price: 13.00, priceGrande: 15.50, description: 'Emmental, Viande de kebab' },
  ],

  // LES CREMES FRAICHES (Base Creme) - "Crème fraîche" omis car induit par la catégorie
  cremes: [
    { name: 'Dame Blanche', price: 13.00, priceGrande: 15.50, description: 'Emmental, Lardons, Oignons' },
    { name: 'Tonthon', price: 13.00, priceGrande: 15.50, description: 'Emmental, Thon, Câpres' },
    { name: 'Chicken', price: 13.00, priceGrande: 15.50, description: 'Emmental, Poulet, Champignons' },
    { name: 'Viking', price: 13.50, priceGrande: 16.00, description: 'Emmental, Saumon, Amandes' },
  ],

  // LES SPECIALITES MAISON - Descriptions exactes de la BDD
  specialites: [
    { name: 'Arménienne', price: 13.50, priceGrande: 16.00, isSpicy: true, description: 'Tomate, Emmental, Oignons, Poivrons, Viande Hachée' },
    { name: 'Pagnol', price: 13.50, priceGrande: 16.00, description: 'Tomate Fraîche, Emmental, Oeuf, Lardons, Herbes' },
    { name: 'Niçoise', price: 13.50, priceGrande: 16.00, description: 'Tomate Fraîche, Oignons, Anchois, Herbes, Huile d\'olive' },
    { name: 'Mexicana', price: 13.50, priceGrande: 16.00, isSpicy: true, description: 'Tomate, Emmental, Oignons, Poivrons, Chorizo' },
    { name: 'Indienne', price: 13.50, priceGrande: 16.00, description: 'Sauce curry, Emmental, Poulet, Poivron' },
    { name: 'Pistou', price: 13.50, priceGrande: 16.00, isVegetarian: true, description: 'Tomate, Ail, Basilic, Tomates cerise, Parmesan' },
    { name: 'Napoléon', price: 13.50, priceGrande: 16.00, description: 'Tomate, Emmental, Figatelli, Brousse' },
    { name: 'Orientale', price: 13.50, priceGrande: 16.00, isSpicy: true, description: 'Tomate, Emmental, Oignons, Poivrons, Merguez' },
    { name: 'Végétarienne', price: 13.50, priceGrande: 16.00, isVegetarian: true, description: 'Tomate, Oignons, Poivrons, Champignons, Emmental' },
  ],
